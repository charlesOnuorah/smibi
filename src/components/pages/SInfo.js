            ...
            <div className='container'>
              ...
              <div className='row' >
                <div className='col-lg-3 col-sm-8'>
                  ...
                  <input className='btn btn-success p-0 m-2 mx-5' style={{width : 1000}} type='button' value='Puberty'/>
                  <input className='btn btn-warning w-100 p-0 m-2 mx-5 fs-12' type='button' value='Human Body & Dev'/>
                  <input className='btn btn-danger w-100 p-0 m-2 mx-5' type='button' value='Negotiation & Decision Skills'/>
                  <input className='btn btn-success w-100 p-0 m-2 mx-5' type='button' value='Consent and Privacy'/>
                  <input className='btn btn-warning w-100 p-0 m-2 mx-5' type='button' value='STIs'/>
